...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddressBar_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AddressBar_t qt_meta_stringdata_AddressBar = {
    {
QT_MOC_LITERAL(0, 0, 10), // "AddressBar"
QT_MOC_LITERAL(1, 11, 11), // "EditAddress"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "AddressBar\0EditAddress\0"
};
...
void AddressBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddressBar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->EditAddress(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AddressBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddressBar::EditAddress)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AddressBar::staticMetaObject = { {
    QMetaObject::SuperData::link<QLineEdit::staticMetaObject>(),
    qt_meta_stringdata_AddressBar.data,
    qt_meta_data_AddressBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AddressBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddressBar.stringdata0))
