...
Dictionary::Dictionary() : dictionary_path(QDir::current()) {
    ...
    dictionary_pictures_map.insert({
        ...
        {"011011", new QIcon(dictionary_path.path() + "/Bracket.ico")},
        {"111101", new QIcon(dictionary_path.path() + "/Colon.ico")},
        {"011010", new QIcon(dictionary_path.path() + "/ExclamationPoint.ico")},
        {"001001", new QIcon(dictionary_path.path() + "/Hyphen.ico")},
        {"001110", new QIcon(dictionary_path.path() + "ParanthesisClose.ico")},
        ...
        {"011000", new QIcon(dictionary_path.path() + "QuoteClose.ico")},
        {"001011", new QIcon(dictionary_path.path() + "QuoteOpen.ico")},
        {"011001", new QIcon(dictionary_path.path() + "Semicolon.ico")}
        //служебные символы
    });
}
